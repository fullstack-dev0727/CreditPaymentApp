...
#define SERVER_INVITE_URL @"http://gratsi.tips/send_email.php"
#define SERVER_STRIPE_URL @"http://gratsi.tips/stripe_payment.php"
#define SERVER_BANK_URL @"http://gratsi.tips/stripe_withdraw.php"
#define SERVER_GOOGLE_URL @"https://maps.googleapis.com/maps/api/place/textsearch/json?query=%@&type=hotel|restaurant&sensor=true&key=AIzaSyDgcKRyipAF4iKLMy3jY5eZr3cxBK1uSrM"
#define SERVER_YELP_URL @"https://api.foursquare.com/v2/venues/search?client_id=IHMLBUW2AY41WLIMSWTYOZ050VYPEBQBSBG4DJ4SFPUKR1SC&client_secret=BRTUJDJ5NO3QAMBSRBID4NKOYTBQEPZHNV0UZ4DL4SUWML1J&v=20130815&query=%@&intent=global&limit=10"
@class FSNConnection;
