...
- (void)setupImageView {
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(10.5f, 10.5f, 54.0f, 51.0f)];
...
- (void)setLayerProperties {
    ...
    _bgLayer.path = path;
    CFRelease(path);
    _bgLayer.fillColor = [UIColor colorWithRed:0.28f green:0.866f blue:0.95f alpha:1.0f].CGColor;
