...
{   
    ...
    if(IS_IOS7)
    {
    [bar setSearchTextPositionAdjustment:UIOffsetMake(0, 0)];
        
      [bar setPositionAdjustment:UIOffsetMake(bar.frame.size.width - 65, 0) forSearchBarIcon:UISearchBarIconSearch];
    }
}
